"""
Django settings for alma_41846 project.
...
WSGI_APPLICATION = 'alma_41846.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "alma_41846 API",
    "DESCRIPTION": "API documentation for alma_41846 App",
    "VERSION": "v1",
}
